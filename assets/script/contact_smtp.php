<?php
/*
plexify Shop & eCommerce HTML Template | Unscripted Travels
...
/* ReCaptch Secret */
$recaptchaSecret = '6LdI6h8sAAAAAE0Iq119YvpobDq26sxdyojayufF';

$dzEmailTo 		= "unscriptedtravels@gmail.com";   /* Receiver Email Address */
$dzEmailFrom    = "unscripted travels";
...
function smtp_mail($dzEmailTo, $dzEmailFrom, $dzEmail, $dzMailSubject, $dzMailMessage)
{
    ...
    $mail->Host       = 'Unscripted Travels.com';                //Set the SMTP server to send through
    $mail->SMTPAuth   = true;                                   //Enable SMTP authentication
    $mail->Username   = 'product@Unscripted Travels.com';                   //SMTP username
...
try {
    if (!empty($_POST)) {
		...
		if($_POST['dzToDo'] == 'Contact')
		{
			...
			$dzMailSubject = 'plexify|Contact Form: A Person want to contact';
			$dzMailMessage	= 	"
